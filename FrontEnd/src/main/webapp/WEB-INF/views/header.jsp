...
<nav class="navbar navbar-inverse" id="nav_bar">
   ...
   data-toggle="collapse" data-target="#collapse-example" aria-expanded="false">
		...
		<img src='<c:url value="/WEB-INF/resources/images/logo1.jpg"></c:url>' alt="NIIT" height="40px" width="120px"></a>
			</div>
      ...
      <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
						...
						<li><a href="signin"><span class="glyphicon glyphicon-user" style="color:blue"></span>
						sign in</a></li>
				<li><a href="signup">
